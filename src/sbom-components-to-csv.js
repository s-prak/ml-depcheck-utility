...
const directoryPath = "../data/sbom-repo-wise";
...
const csvFilePath="./unique-components.csv";
//fs.writeFileSync(csvFilePath,csvContent,'utf-8');


//Create a new csv file to merge the components and dependencies 
let dep_com_merge="dependency,type,license-id,group,name,version,publish_details,services\n";
//file to read the dependencies 
const filePath2="../data/dependencies-services-last-publish.csv";
try {
...
const csvFilePath2="../data/SBOM-aggregate.csv";
